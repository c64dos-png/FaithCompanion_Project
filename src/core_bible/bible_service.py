...
from .models import BibleVerse, BibleBook, BibleTranslation, BibleTestament, VerseRange
...
class BibleService:
    ...
    def _initialize_books(self) -> Dict[str, BibleBook]:
        ...
        books = {
            "gen": BibleBook(id="gen", name="Genesis", abbreviation="Gen", testament=BibleTestament.OLD, order=1, chapter_count=50),
            "exo": BibleBook(id="exo", name="Exodus", abbreviation="Exo", testament=BibleTestament.OLD, order=2, chapter_count=40),
            "mat": BibleBook(id="mat", name="Matthew", abbreviation="Mat", testament=BibleTestament.NEW, order=40, chapter_count=28),
            "jhn": BibleBook(id="jhn", name="John", abbreviation="Jhn", testament=BibleTestament.NEW, order=43, chapter_count=21),
            "rom": BibleBook(id="rom", name="Romans", abbreviation="Rom", testament=BibleTestament.NEW, order=45, chapter_count=16),
        }
        return books
    ...
    def get_all_books(self, testament: Optional[BibleTestament] = None) -> List[BibleBook]:
        """
